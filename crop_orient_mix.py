# -*- coding: utf-8 -*-
"""
Created on Thu Dec 19 13:16:28 2019
...
def process_image(path, out_path):
    ...
    text_im = text_im.resize((w,h), Image.ANTIALIAS)
    text_im.save(out_path)
    #print('%s -> %s' % (path, out_path))
    return text_im
    
def crop_orient(pat,img):
    path=pat
    
## (1) read
   # path=r"C:\Users\Internship004\Desktop\rot3.jpg"
    img = cv2.imread(path)
    ...
    if(median_angle<5 and median_angle>-5):
        ...
        out_path = 'orig.jpg'
        ret_img=process_image('orig.jpg', out_path)
        open_cv_image = np.array(ret_img) 
# Convert RGB to BGR 
