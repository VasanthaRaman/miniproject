...
''' Read the image '''
img = cv2.imread(r"C:\Users\Internship005\skew_corrected.png",1)
...
with open("C:/Users/Internship005/Desktop/newjson.json",'w') as jsonFile:
...
cnt=0
f = open("C:/Users/Internship005/Desktop/newjson.json",'r',encoding='utf8')
for line in f:
    cnt+=1
